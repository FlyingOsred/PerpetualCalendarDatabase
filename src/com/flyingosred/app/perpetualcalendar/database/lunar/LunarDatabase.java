...
public class LunarDatabase {
    ...
    private static long[] LUNAR_DATABASE = new long[] { 0x04AE53, 0x0A5748, 0x5526BD, 0x0D2650, 0x0D9544, 0x46AAB9,
    ...
    public static Calendar getSpringFestivalDay(int year) {
        Calendar calendar = Calendar.getInstance();
        long data = LUNAR_DATABASE[year - LUNAR_YEAR_MIN];
    ...
    public static int getLunarDaysInMonth(int year, int bit) {
